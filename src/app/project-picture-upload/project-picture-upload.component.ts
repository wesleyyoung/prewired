...
@Component({
  selector: 'app-project-picture-upload',
  templateUrl: './project-picture-upload.component.html',
  styleUrls: ['./project-picture-upload.component.scss'],
})
export class ProjectPictureUploadComponent implements OnInit {
